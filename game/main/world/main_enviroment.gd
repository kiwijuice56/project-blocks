...
@export var water_fog_light_emission: Color
...
var default_volumetric_fog_emission: Color
...
func _ready() -> void:
	...
	default_volumetric_fog_emission = environment.volumetric_fog_emission 
...
func _on_under_water_status_changed(new_val: bool) -> void:
	if new_val:
		...
		environment.volumetric_fog_emission = water_fog_light_emission
	else:
		...
		environment.volumetric_fog_emission = default_volumetric_fog_emission
